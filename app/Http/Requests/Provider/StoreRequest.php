...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            // 'ruc_numbre'=>'required|string|max:50',
    ...
    //             'email'=>'reqired|email|string|max:255|unique:providers',
    //             'ruc_number'=>'reqired|string|max:|max:11|min:11|unique:providers',
    //             'address'=>'nullable|string|max:255',
    //             'phone'=>'reqired|string|max:9|min:9|unique:providers',
