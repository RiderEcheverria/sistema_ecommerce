  ...
  <div class="modal fade m-medium" id="modal-delete-user{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-user">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
            ...
            <center> <h4>El registro N:<b>{{ $role->id}}</b></h4></center>
