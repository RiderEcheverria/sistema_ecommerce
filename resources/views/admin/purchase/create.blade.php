...
<script>
    ...
    function agregar() {
        ...
        if (product_id != "" && quantity != "" && quantity > 0 && price != "") {
            ...
            var fila = 
            '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-danger btn-sm" onclick="eliminar('
                +cont+');"><i class="fa fa-times"></i></button></td> <td><input type="hidden" name="product_id[]" value="'
