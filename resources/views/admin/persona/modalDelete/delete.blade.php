  ...
  {!! Form::model($persona, ['route' => ['personas.update', $persona], 'method' => 'PUT']) !!}
              <input  style="display:none" type="text" name="name" id="name" value="{{ $persona->name }}"
              ...
              required>
              <input  style="display:none" type="text" name="surname" id="surname"
              ...
              <input  style="display:none" type="text" name="cedula" id="cedula"
              ...
              <select  style="display:none" name="estatus" value="{{ old('estatus', $persona->estatus) }}" class="form-control" id="exampleSelectGender">
              <option value="0">Inactivo</option>
              </select>
              <input  style="display:none" type="text" name="celular" id="celular"
              ...
              onKeyPress="if(this.value.length==8) return false;" min="0" />                                                                                                                       
  <div class="modal fade m-medium" id="modal-delete-edit{{$persona->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-edit">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <center> <h4>El registro N:<b>{{ $persona->id}}</b></h4></center>
