  ...
  {!! Form::model($provider, ['route' => ['providers.update', $provider], 'method' => 'PUT']) !!}
            ...
            required>
            <input style="display:none" type="number" name="nit" id="nit" value="{{ $provider->nit }}"
            ...
            <input style="display:none"  type="email" name="email" id="email"
          ...
          <select style="display:none"  name="estatus" value="{{ old('estatus', $provider->estatus) }}" class="form-control" id="exampleSelectGender">
              <option value="0">Inactivo</option>
            </select>                                                                                                                        
  <div class="modal fade m-medium" id="modal-delete-edit{{$provider->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-edit">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <center> <h4>El registro N:<b>{{ $provider->id}}</b></h4></center>
