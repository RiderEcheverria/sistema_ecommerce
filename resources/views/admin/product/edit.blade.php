            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        rows="26">{{ $product->description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select  name="status" value="{{ old('status', $brand->status) }}" class="form-control" id="status">
                            <option selected>Seleccione el estado</option>
                            <option value="1">Disponible</option>
                            <option value="0">Agotado</option>
                        </select>
                    </div>
                    <img src="{{asset('image/'.$product->image)}}" width="250">
                    @if($product->status == 1)
