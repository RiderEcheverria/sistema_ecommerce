  ...
  {!! Form::model($category, ['route' => ['categories.update', $category], 'method' => 'PUT']) !!}
            ...
            <input style="display:none" type="text" value="{{ $category->name }}" name="name" id="name" class="form-control" 
            placeholder="Escriba una marca" required onkeypress="return soloLetras(event)" />
     
                <select style="display:none" name="estatus" value="{{ old('estatus', $category->estatus) }}" 
  ...
  <div class="modal fade m-medium" id="modal-delete-edit{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-edit">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <center> <h4>El registro N:<b>{{ $category->id}}</b></h4></center>
