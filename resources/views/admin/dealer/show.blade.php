                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="btn-group-vertical">
                                                    <button type="button" class="btn btn-outline-primary">Sobre repartisor
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-outline-primary">Productos</button>
                                                    <button type="button" class="btn btn-outline-primary">Registrar
                                                        producto</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-7 pl-lg-6">
                                                <div class="d-flex justify-content-between">
                                                    <h4>Informacion de repartisor</h4>
